...
exports.forgotPost = function(req, res, next) {
  ...
  async.waterfall([
    ...
    function(token, user, done) {
      ...
      var mailOptions = {
        to: user.email,
        from: 'fabio.trentino28@protonmail.com',
        subject: 'Redefinir sua senha no MegaMoviesLibre',
        text: 'Oi, tudo bem?\n\n Você está recebendo esse email porque pediu para redefenir a senha da sua conta no MegaMoviesLibre.\n\n' +
  ...
  async.waterfall([
    ...
    function(user, done) {
      ...
      var mailOptions = {
        from: 'fabio.trentino28@protonmail.com',
        to: user.email,
        subject: 'Sua senha no MegaMoviesLibre foi alterada',
        text: 'Olá! Tudo bem? \n\n' +
        'Este e-mail é uma confirmação que a senha da sua conta no MegaMoviesLibre (' + user.email + ') foi alterada recentemente.\n\nAbraços Libres! <3\n\nTime Libreflix\n\n'
      };
      transporter.sendMail(mailOptions, function(err) {
